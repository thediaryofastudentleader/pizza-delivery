...
export const PizzaCanvas = () => {
    ...
    return (
        <div
            ...
            className={`relative w-full h-96 rounded-2xl border-4 border-dashed transition-all duration-300 flex items-center justify-center ${isOver ? "border-green-500 bg-green-50" : "border-gray-300 bg-gray-100"
                }`}
        >
